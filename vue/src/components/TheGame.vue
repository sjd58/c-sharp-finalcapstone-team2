<template>
  <div class="game">
    ...
    <audio
      id="plasmaCannonSound"
      src="/Sounds/plasmacannon.wav"
      preload="auto"
    ></audio>
    ...
    <audio
      id="backgroundMusic"
      src="/Sounds/SpanishCafeMusic.mp3"
      preload="auto"
      loop
    ></audio>
    <p id="fedCustomers">Customer's Fed Tacos: <span id="npcHitCount">0</span></p>
  </div>
</template>
...
plasmaCannonSound = document.getElementById("plasmaCannonSound");
backgroundMusic = document.getElementById("backgroundMusic");
startGameButton = document.getElementById("startGame");

// tracks the NPC hit count
npcHitCountElement = document.getElementById("npcHitCount");

startGameButton.addEventListener('click', () => {
    cannon = new Cannon();
    mountain = new Mountain();
    moon = new Moon();
    saturn = new Saturn(ctx);
    nebula = new Nebula(saturn.x + 450, moon.y + 30);
